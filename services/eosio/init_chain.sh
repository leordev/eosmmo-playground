...
EOSMC_ACCOUNT_PRIVATE_OWNER_KEY="5KNtiQbanVwWvnaUu8L7U4QxtrVXbLSvQDJW681njcSrxncs33n"
EOSMC_ACCOUNT_PUBLIC_OWNER_KEY="EOS6KK4CZpN8qpEfMRk49yQY1vAWRE6VAHtauSCRZP5hp8pcHUD7V"

EOSMC_ACCOUNT_PRIVATE_ACTIVE_KEY="5J2tFy97YHdi8tqMA1o9tyPnNn2qqXvUazYdyXnxZtP9RA2J1Vu"
EOSMC_ACCOUNT_PUBLIC_ACTIVE_KEY="EOS6GmTt1ikiC6wPMhqBLQFtMw2UqZSbbi2WVTqyG1UtiGhcpko2R"
...
$CLEOS wallet import --private-key $EOSMC_ACCOUNT_PRIVATE_OWNER_KEY
$CLEOS wallet import --private-key $EOSMC_ACCOUNT_PRIVATE_ACTIVE_KEY

$CLEOS system newaccount eosio --transfer eosmcserver $EOSMC_ACCOUNT_PUBLIC_OWNER_KEY $EOSMC_ACCOUNT_PUBLIC_ACTIVE_KEY --stake-net "100000.0000 SYS" --stake-cpu "100000.0000 SYS" --buy-ram "100000.000 SYS"
$CLEOS transfer eosio eosmcserver "1000000.0000 SYS"

$CLEOS set contract eosmcserver /opt/application/eosmcserver
